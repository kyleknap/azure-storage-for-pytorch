    ...
    def on_response(self, request, response):
        ...
        if request_client_id != response_client_id:
            raise azure.core.exceptions.AzureError(
                ...
                "worker process. This can cause unintentional sharing of resources. To fix this "
                "error, consider not accessing the dataset's samples in the main process or "
                "not using workers with the DataLoader."
            )
